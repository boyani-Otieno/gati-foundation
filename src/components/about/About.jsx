...
const About = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      text: "Martha Boke is a passionate advocate for women's and girl's health, nutrition, and climate resilience. She holds a Bachelor's Degree in Nutrition and Dietetics from the Technical University of Kenya and is a 2024 Women's Global Leadership Forum (WILD) Fellow. She has gained extensive experience working with leading health institutions, including the Nutrition Department at Kuria District Hospital, Mama Lucy Hospital, and Kenyatta National Hospital. Currently, Martha offers her expertise to Spur Africa Organization, focusing on health and nutrition programs. Martha’s dedication to improving the well-being of women and girls drives her work at the Margaret Robi Foundation, where she leads initiatives aimed at addressing nutritional challenges, promoting healthy lifestyles within marginalized communities, and advancing climate resilience among vulnerable populations. Her vision is to create a future where women and girls have equitable access to healthcare and nutritional resources, enabling them to thrive and contribute to society.",
